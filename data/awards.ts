...
export const awards: Award[] = [
    {
        ...
        year: "2018",
        category: "Finalist",
        description: "Recognised for exceptional leadership and contribution to the security industry at a young age.",
        aboutAward: "The Outstanding Security Performance Awards (OSPAs) recognise and reward companies and individuals across the security sector.",
    ...
    },
    {
        ...
        year: "2018",
        category: "Winner",
        description: "Recognising individual officers who have gone above and beyond in their duties.",
