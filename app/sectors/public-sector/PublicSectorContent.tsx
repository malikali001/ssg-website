...
export default function PublicSectorContent() {
    ...
    const challenges = [
        ...
        { title: "Diverse Threats", description: "Managing anti-social behaviour, protest activity, and targeted threats against officials and staff." }
    ];
    ...
    const solutions = [
        ...
        { title: "Conflict Management", description: "Specialised training to de-escalate volatile situations in both public and clinical settings." }
    ];
